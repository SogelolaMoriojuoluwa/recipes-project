          ...
          {recipesImg.slice(0, 6).map((recipe, index) => (
            ...
            <div>               
              ...
              <button className="arrow animated infinite bounce" >
                <Link to="Recipe" smooth='easeOutQuad' duration={1500}>
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-arrow-down-square-fill" viewBox="0 0 16 16">
